...
![Gradle](https://img.shields.io/badge/Gradle-7.4.2-blue?labelColor=black)
...
* We use static gradle projects saved under [src/functionalTest/resources](my-gradle-plugins/my-settings-gradle-plugin/src/functionalTest/resources) but we can also generate gradle projects programmatically, saving them on temporary folders (check [this sample](https://docs.gradle.org/current/userguide/test_kit.html#example_using_gradlerunner_with_java_and_junit)).
