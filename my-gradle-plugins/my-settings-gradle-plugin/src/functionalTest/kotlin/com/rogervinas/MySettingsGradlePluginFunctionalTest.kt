...
class MySettingsGradlePluginFunctionalTest {
  ...
  fun `should add new task to single-project`() {
    ...
    assertThat(result.output).all {
      contains("Plugin com.rogervinas.MySettingsGradlePlugin applied on single-project")
  ...
  fun `should add new task to multi-project`() {
    ...
    assertThat(result.output).all {
      contains("Plugin com.rogervinas.MySettingsGradlePlugin applied on multi-project")
